<?php
    ...
    if(isset($_POST['save']))
    {
        ...
        if($result){ 
            ...
            $qrData = "ID: $last_id, Violation Type: $Violation_type, Enforcement Type: $Enforcement_type, Demerit Points: $Demerit_point";
            $qrCodeFile = '../qrcodes/' . uniqid() . '.png'; // Unique filename for QR code

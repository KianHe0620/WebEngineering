...
<body>
    ...
    <div class="content">
        ...
        <div id="section1">
            ...
            <div>
            <p>Parking A (Staff)  <span style="border: 1px solid black; padding:10px;">23</span></p>
            </div>
            <div>
            <p>Parking B (Student)   <span style="border: 1px solid black; padding:10px;">23</span></p>
            </div>
        </div>
        <div id="section2">
            <h3>Section 2</h3>
